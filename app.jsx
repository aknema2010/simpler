 ...
 * (app.js) so the browser runs it directly with no runtime Babel step. All
 * audio is synthesized in real time with the Web Audio API, so the app has no
 * binary sound assets and works fully offline once the page is cached.
 *
 * Sound engines:
